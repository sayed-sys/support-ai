      ...
      <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-2xl border border-slate-200">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-slate-100">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="font-bold text-slate-900 text-sm">Create Your Support AI</h3>
        ...
        {step === 1 && (
          <div className="space-y-4">
            <div>
              ...
              <h2 className="text-xl font-bold text-slate-900 mt-0.5">What is your business name?</h2>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-300 pl-11 pr-4 py-2.5 text-sm focus:border-blue-500 focus:outline-none"
              />
            </div>
            ...
            <div className="pt-4 flex justify-end">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 disabled:opacity-40 transition"
              >
                Next
        ...
        {step === 2 && (
          <div className="space-y-4">
            <div>
              ...
              <h2 className="text-xl font-bold text-slate-900 mt-0.5">What does your business do?</h2>
              <p className="text-xs text-slate-500 mt-1">
        ...
        {step === 3 && (
          <div className="space-y-4">
            <div>
              ...
              <h2 className="text-xl font-bold text-slate-900 mt-0.5">What is your website URL?</h2>
              <p className="text-xs text-slate-500 mt-1">
        ...
        {step === 5 && (
          <div className="text-center py-6 space-y-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-slate-900">Your AI agent is ready!</h2>
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-left text-xs space-y-2 max-w-sm mx-auto">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-slate-800">Friendly & Professional</span>
              </div>
              <div className="flex justify-between">
