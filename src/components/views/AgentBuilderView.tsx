  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold text-slate-900">AI Agent Customizer & Personality</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="inline-flex items-center gap-2 rounded-xl bg-blue-600 px-4 py-2 text-xs font-semibold text-white shadow-xs hover:bg-blue-700 disabled:opacity-50 transition"
          >
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xs space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full font-mono text-xs rounded-xl border border-slate-300 p-3 text-slate-800 focus:border-blue-500 focus:outline-none"
              />
            </div>
