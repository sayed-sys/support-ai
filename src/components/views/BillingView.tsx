...
export const BillingView: React.FC<BillingViewProps> = ({
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-xl font-bold text-slate-900">Subscription & Usage Limits</h1>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xs space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="capitalize font-bold text-xs bg-blue-50 text-blue-700 px-2.5 py-0.5 rounded-full border border-blue-200">
                {workspace.plan} Tier
              </span>
            </div>
        ...
        <div className="flex flex-wrap items-center justify-between text-xs text-slate-500 pt-2 border-t border-slate-100">
          ...
          <span>Payment Status: Active Card ending in •••• 4242</span>
        </div>
      </div>
          ...
          return (
            <div
              ...
              className={`rounded-2xl bg-white p-6 flex flex-col justify-between transition ${
                p.popular
                  ? 'border-2 border-blue-600 shadow-md relative'
