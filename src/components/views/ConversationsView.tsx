          ...
          <div className="p-4 border-b border-slate-200 space-y-3">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-300 pl-8 pr-3 py-1.5 text-xs focus:border-blue-500 focus:outline-none"
              />
            </div>
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mt-1 pt-1">
                      {c.status === 'ai_handling' && (
                        <span className="inline-flex items-center gap-1 text-[10px] text-blue-700 bg-blue-100/70 px-2 py-0.5 rounded-full font-medium">
                      ...
                      {!isCustomer && (
                        <div
                          className={`h-8 w-8 rounded-full flex items-center justify-center font-bold text-xs text-white shrink-0 mt-0.5 ${
                            isHuman ? 'bg-slate-900' : 'bg-indigo-600'
                          }`}
                        >
                          {isHuman ? 'H' : 'AI'}
                        </div>
            ...
            <div className="p-3.5 bg-white border-t border-slate-200">
              <form onSubmit={handleSendHumanReply} className="flex items-center gap-2">
                <input
                  ...
                  className="flex-1 rounded-md border border-slate-300 px-3 py-2 text-xs text-slate-800 focus:border-indigo-500 focus:outline-none transition"
                />
                <button
                  type="submit"
                  disabled={!humanReplyText.trim() || sendingReply}
                  className="inline-flex items-center gap-1.5 rounded-md bg-indigo-600 px-3.5 py-2 text-xs font-semibold text-white shadow-xs hover:bg-indigo-700 disabled:opacity-40 transition shrink-0"
                >
