  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold text-slate-900">Customer Profiles & CRM</h1>
          ...
          <div className="w-full max-w-md bg-white h-full shadow-2xl p-6 overflow-y-auto flex flex-col justify-between">
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                <div className="h-14 w-14 rounded-2xl bg-blue-100 text-blue-700 font-bold text-lg flex items-center justify-center">
              ...
              <div className="p-4 rounded-xl border border-slate-200 bg-slate-50 space-y-2 text-xs">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-emerald-600">
                    {selectedCustomer.satisfactionScore ? `${selectedCustomer.satisfactionScore}/5` : 'N/A'}
                  </span>
                </div>
                <div className="flex justify-between">
