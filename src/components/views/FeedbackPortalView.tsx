...
export const FeedbackPortalView: React.FC<FeedbackPortalViewProps> = ({ initialItems }) => {
  ...
  return (
    <div className="space-y-6">
      {/* Header Banner */}
      <div className="rounded-2xl border border-indigo-200 bg-linear-to-r from-indigo-50/70 to-blue-50/70 p-6 shadow-xs flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            <span className="rounded-full bg-indigo-600 text-white px-2.5 py-0.5 text-xs font-bold uppercase tracking-wider">
              AI Backlog Optimizer
            </span>
            <span className="text-xs text-indigo-700 font-semibold">Priority Engine Active</span>
          </div>
          <h1 className="text-xl font-bold text-slate-900 mt-1">Customer Feedback & Feature Matrix</h1>
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-4 py-2 text-xs font-semibold text-white shadow-xs hover:bg-indigo-700 disabled:opacity-50 transition"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="p-4 rounded-xl border border-slate-200 bg-white">
          ...
          <div className="text-xl font-bold text-amber-600 mt-1">
            {items.reduce((acc, i) => acc + (i.clusterCount > 1 ? 1 : 0), 0)} recurring patterns
          </div>
        </div>
        <div className="p-4 rounded-xl border border-slate-200 bg-white">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          ...
          >
            ...
            <option value="bug">Bugs / Friction</option>
            <option value="integration">Integrations</option>
            <option value="ux">UX / Navigation</option>
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    <button
                      ...
                      className="flex flex-col items-center justify-center h-12 w-12 rounded-xl border border-slate-200 bg-slate-50 hover:bg-indigo-50 hover:border-indigo-300 hover:text-indigo-600 transition group shrink-0"
                    >
                    ...
                    <div className="space-y-1">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <span className="capitalize text-[11px] bg-indigo-50 text-indigo-700 border border-indigo-200 px-2 py-0.5 rounded-full font-medium">
          ...
          <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-2xl border border-slate-200">
            ...
            <form onSubmit={handleSubmitFeedback} className="mt-4 space-y-3.5">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  >
                    ...
                    <option value="bug">Bug / Friction</option>
              ...
              <div className="pt-3 flex justify-end gap-2">
                ...
                <button
                  type="submit"
                  className="rounded-xl bg-indigo-600 px-5 py-2 text-xs font-semibold text-white hover:bg-indigo-700 shadow-xs transition"
                >
                  Submit Feedback
                </button>
              </div>
