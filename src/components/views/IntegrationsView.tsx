...
></script>`;
  ...
  return (
    <div className="space-y-6">
      {/* Top Header */}
      <div>
        <h1 className="text-xl font-bold text-slate-900">Integrations & Website Embed</h1>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xs space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500">
                Paste this script tag right before the closing <code className="text-blue-600 font-mono">&lt;/body&gt;</code> or in your <code className="text-blue-600 font-mono">&lt;head&gt;</code> tag.
              </p>
            </div>
          </div>
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-xl bg-blue-600 px-3.5 py-1.5 text-xs font-semibold text-white shadow-xs hover:bg-blue-700 transition"
          >
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xs space-y-4">
        ...
        <form onSubmit={handleShopifyLookup} className="flex gap-2 max-w-md">
          <input
            ...
            className="flex-1 rounded-xl border border-slate-300 px-3.5 py-2 text-xs focus:border-blue-500 focus:outline-none"
          />
          <button
            type="submit"
            disabled={lookingUp}
            ...
            {orderResult.found ? (
              <>
                ...
                <div className="flex justify-between text-slate-600">
                  ...
                  <span className="font-mono text-blue-600">{orderResult.order.trackingNumber}</span>
                </div>
                <div className="flex justify-between text-slate-600">
