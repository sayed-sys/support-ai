  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-4">
          <span className="text-xs text-slate-500">Retrieval Accuracy</span>
          <div className="text-xl font-bold text-emerald-600 mt-1">99.4% Verified Grounding</div>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="relative w-full sm:w-72">
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-300 pl-9 pr-4 py-1.5 text-xs focus:border-blue-500 focus:outline-none"
          />
        </div>
      </div>
              ...
              >
                <div className="flex items-start gap-3.5">
                  <div className="h-9 w-9 rounded-xl bg-slate-100 flex items-center justify-center text-slate-600 shrink-0 mt-0.5">
                    {source.type === 'website' && <Globe className="h-5 w-5 text-blue-600" />}
                    {source.type === 'document' && <FileText className="h-5 w-5 text-indigo-600" />}
            ...
            <form onSubmit={handleAddSource} className="space-y-4">
              ...
              <div className="pt-2 flex justify-end gap-2">
                ...
                <button
                  ...
                  className="rounded-xl bg-blue-600 px-5 py-2 text-xs font-semibold text-white hover:bg-blue-700 disabled:opacity-40 transition"
                >
