    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5">
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-2xs">
          ...
          <div className="text-2xl font-bold text-slate-900 mt-1">{analytics.totalConversations}</div>
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-2xs">
          ...
          <div className="text-2xl font-bold text-slate-900 mt-1">{analytics.aiResolvedRate}%</div>
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-2xs">
          ...
          <div className="text-2xl font-bold text-slate-900 mt-1">{analytics.avgResponseTimeSec}s</div>
          <div className="text-[10px] text-indigo-600 font-medium mt-1">Instant RAG response</div>
        </div>
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-2xs">
          ...
          <div className="text-2xl font-bold text-slate-900 mt-1">{analytics.escalatedCount}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                {recentConversations.slice(0, 6).map((conv) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2.5 text-right">
                      <span className="text-indigo-600 font-semibold hover:underline text-[11px]">
                        Open →
                      </span>
                    </td>
                  </tr>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-2xs">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-[10px] text-slate-400">
                    {workspace.usage.docsCount * 42} chunks embedded
                  </div>
                </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-[10px] font-bold text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded border border-indigo-200">
                  SYNCED
                </div>
              </div>
            </div>
          ...
          <div className="bg-[#1E293B] rounded-xl p-4 text-white shadow-2xs flex-1 flex flex-col justify-between">
            <div>
              <div className="flex justify-between items-start mb-2">
                <h2 className="font-bold text-sm">AI Improvements</h2>
                <span className="px-1.5 py-0.5 bg-indigo-500 text-white text-[10px] rounded uppercase font-bold">
                  3 New
                </span>
              </div>
              ...
              <div className="space-y-2">
                <div className="p-2.5 bg-slate-900/80 rounded-lg border border-slate-700">
                  <div className="text-[10px] text-indigo-400 font-bold mb-0.5">Customer asked:</div>
                  <div className="text-xs text-slate-200 leading-relaxed italic">
                    "Is the winter jacket waterproof enough for heavy snow?"
                  </div>
                  <button
                    onClick={() => onNavigate('unanswered')}
                    className="mt-2 text-[10px] bg-indigo-600 hover:bg-indigo-500 text-white px-2.5 py-1 rounded font-bold transition"
                  >
                    Teach Answer
                  </button>
                </div>
                ...
                <div className="p-2.5 bg-slate-900/80 rounded-lg border border-slate-700">
                  <div className="text-[10px] text-indigo-400 font-bold mb-0.5">Customer asked:</div>
                  <div className="text-xs text-slate-200 leading-relaxed italic">
                    "When is the upcoming Black Friday sale starting?"
                  </div>
                  <button
                    onClick={() => onNavigate('unanswered')}
                    className="mt-2 text-[10px] bg-indigo-600 hover:bg-indigo-500 text-white px-2.5 py-1 rounded font-bold transition"
