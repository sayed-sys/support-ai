...
export const SettingsView: React.FC<SettingsViewProps> = ({
  ...
  const [inviteRole, setInviteRole] = useState<'admin' | 'support_agent' | 'viewer'>('support_agent');
  ...
  return (
    <div className="space-y-6">
      {/* Top Header */}
      <div>
        <h1 className="text-xl font-bold text-slate-900">Workspace Settings & Team</h1>
            ...
            <form onSubmit={handleInvite} className="mt-4 space-y-3.5">
              ...
              <div>
                ...
                >
                  ...
                  <option value="support_agent">Support Agent (Live Chat Takeover & Knowledge)</option>
