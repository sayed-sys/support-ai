...
export const UnansweredQuestionsView: React.FC<UnansweredQuestionsViewProps> = ({
  ...
  const handleSaveAnswer = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setQuestions((prev) =>
        prev.map((q) => (q.id === selectedQuestion.id ? { ...q, resolved: true } : q))
      );
      onKnowledgeUpdated();
      setTimeout(() => {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-xl font-bold text-slate-900 mt-1">Unanswered Customer Questions</h1>
              ...
              >
                <div className="space-y-1.5 max-w-2xl">
                  ...
                  <div className="flex items-center gap-3 text-[11px] text-slate-400">
                    ...
                    <span>•</span>
                    <span>Last asked {new Date(q.lastAskedAt).toLocaleDateString()}</span>
                  </div>
                </div>
            ...
            <form onSubmit={handleSaveAnswer} className="mt-4 space-y-4">
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border border-slate-300 p-3 text-sm text-slate-900 focus:border-blue-500 focus:outline-none"
                />
